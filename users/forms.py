...
class UserLoginForm(AuthenticationForm):
    class Meta:
        ...
        widgets = {
            'username': forms.TextInput(attrs={'class': 'form-control form-control-sm', 'placeholder': 'Ingrese su nombre de Usuario'}),
            'password': forms.PasswordInput(attrs={'class': 'form-control form-control-sm', 'placeholder': 'Ingrese su Contraseña'}),
        }
...
class SignUpForm(UserCreationForm):
    class Meta:
        ...
        widgets = {
            ...
            'email': forms.EmailInput(attrs={'class': 'form-control form-control-sm', 'placeholder': 'Ingrese su Email'}),
